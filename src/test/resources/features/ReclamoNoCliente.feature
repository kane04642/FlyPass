...
Característica: : Creacion de reclamo como NO cliente
  ...
  Esquema del escenario: : Usuario no registrado registra reclamo
    ...
    Ejemplos:
      ...
      | pepe   | perez     | DNI           | 87030511        | 93320101 | 93302014545 | correo@correo.com | AVENIDA   | CAnovas     | 26  | Edificio     | Feria        | Canovas        | 4    | Casa         | B        | Etapa      | Canovas      | B  | 1  | Pueblo Joven    | CAnovas           | CALLAO       | CALLAO    | LA PERLA | 26       | OBRAS EXTERNAS | DESMONTE EN VÍA PÚBLICA | Test               | PRODUCTO       | bienDescripcion |